...
class CombinedInterface(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # File selection
        file_group = QGroupBox("YAML File")
        file_layout = QVBoxLayout(file_group)

        self.file_label = QLabel("No file selected")
        self.select_file_btn = QPushButton("Select a YAML file")
        self.select_file_btn.clicked.connect(self.select_yaml_file)
        ...
        file_layout.addLayout(sol_layout)
