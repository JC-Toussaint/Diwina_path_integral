...
try:
    ...
    class CombinedInterface(QMainWindow):
        ...
        def update_mesh(self):
            ...
            # Caméra stable
                ...
                print(f"Error while updating mesh: {e}")
    ...
    print("PyQt5 not fully installed")
    sys.exit()
